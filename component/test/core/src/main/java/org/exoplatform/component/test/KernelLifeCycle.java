...
/**
 * <p>The kernel life cycle is a JUnit rule for simplifying the life cycle of eXo kernel
 * in unit tests. The kernel configuration uses annotation for declaring the kernel
 * configuration files to load. The rule can either be scoped at the class level or at
 * the test level depending on the life cycle of the kernel required for the tested class.</p>
 *
 * <p>The following example runs a kernel for the whole test case:</p>
 *
 * <code><pre>
 ...
 * </pre></code>
 *
 * <p>The kernel life cycle can also follow the test methods of a test case:</p>
 *
 * <code><pre>
