...
public class PortalRedirect extends ModelObject
{
   ...
   {
      RedirectData redirectData = new RedirectData(storageId, redirectSite, name, enabled, buildRedirectConditionData(conditions), buildRedirectMappingsData(mappings));
