...
public class RedirectData extends ComponentData
{
   ...
   public RedirectData(String storageId, String redirectSiteName, String redirectName, boolean enabled, List<RedirectConditionData> conditions, RedirectMappingsData mappings)
   {
