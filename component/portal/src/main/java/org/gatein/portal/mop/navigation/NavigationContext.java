...
public class NavigationContext {
     ...
     * Returns the navigation state.
     *
     * @param update true if we want the update, false if we want the status
     * @return the navigation state
     */
    public NavigationState getState(boolean update) {
    ...
    /**
     * Returns true if the navigation is persistent.
     *
     * @return the persistent status
     */
