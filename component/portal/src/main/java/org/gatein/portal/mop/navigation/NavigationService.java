 ...
 * loading of the nodes, a {@link org.gatein.portal.mop.hierarchy.Scope} is used to describe the set of nodes that should be retrieved when a loading operation
 * is performed.
 * </p>
 *
 * <p>
 * The node operations does not provide a model per se, but instead use the {@link org.gatein.portal.mop.hierarchy.NodeModel} interface to plug an API model.
