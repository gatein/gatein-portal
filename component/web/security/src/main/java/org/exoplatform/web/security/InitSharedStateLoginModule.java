...
/**
 * Login module is used to add credentials from JAAS callback into shared state. It's intended to be used in JAAS chain
 * before login modules, which depend on credentials in shared state (like {@link org.exoplatform.services.security.jaas.SharedStateLoginModule}
 *
