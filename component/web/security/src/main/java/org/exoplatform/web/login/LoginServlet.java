 ...
 *
 * 0. If user is already authenticated : nothing happens
 * 1. When username and password are provided, a login is attempted
 * 1.1 if login is successful the user is authenticated
 * 1.2 if login fails the user is not authenticated and the login form is displayed with the user name filled
 * 2. When username is provided, the login form is displayed with the user name filled
 * 3. Finally if nothing is provided the login form is displayed
 *
...
public class LoginServlet extends AbstractHttpServlet
{
   ...
   /**
    * Register WCI authentication listener, which is used to bind credentials to temporary authentication registry after
