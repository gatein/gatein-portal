...
public class TestGateInResourcesDeployer extends AbstractWebResourceTest {
    ...
    public void testAddRemoveValid() throws Exception {
        ...
        WebApp webApp = new WebAppImpl(mockServletContext, Thread.currentThread().getContextClassLoader());
        URL url = portalContainer.getPortalClassLoader().getResource("resources-deployment-service/gatein-resources-valid.xml");
        deployer.add(webApp, url);
    ...
    public void testAddRemoveBrokenGmdDependencies() throws Exception {
        ...
        WebApp webApp = new WebAppImpl(mockServletContext, Thread.currentThread().getContextClassLoader());
        URL url = portalContainer.getPortalClassLoader().getResource("resources-deployment-service/gatein-resources-with-broken-gmd-deps.xml");
