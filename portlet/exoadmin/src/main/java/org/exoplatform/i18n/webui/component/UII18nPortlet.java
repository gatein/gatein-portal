...
@ComponentConfigs({
   @ComponentConfig(template = "system:/groovy/webui/organization/i18n/UII18N.gtmpl", lifecycle = UIApplicationLifecycle.class, events = {
   ...
   @ComponentConfig(id = "UISearchI18n", type = UIForm.class, lifecycle = UIFormLifecycle.class, template = "system:/groovy/webui/form/UIFormWithTitle.gtmpl", events = {
...
public class UII18nPortlet extends UIPortletApplication
{
   ...
   public UII18nPortlet() throws Exception
   {
      ...
      uiRepeater.setLabel("UII18nPortlet");
