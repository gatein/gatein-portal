...
public class UIEditResource extends UIForm
{
   ...
   {
      addUIFormInput(new UIFormStringInput("name", null, null).addValidator(MandatoryValidator.class).addValidator(
   ...
   static public class SaveActionListener extends EventListener<UIEditResource>
   {
      public void execute(Event<UIEditResource> event) throws Exception
      {
         ...
         if (uiEditResource.isSave())
            ...
            uiI18n.update(uiI18n.getLastQuery().getName(), uiI18n.getLastQuery().getLanguage());
