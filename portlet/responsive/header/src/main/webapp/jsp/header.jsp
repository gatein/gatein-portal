...
<jsp:useBean id="header"
	class="org.gatein.portlet.responsive.header.HeaderBean" />
...
<script type="text/javascript">
	...
	function checkGRHSize()
	{
		...
		if (((mainWidth - maxWidthForOptions) < 0) && expanded == true) {
			GRHOptionsDiv.className="hidden";
			GRHIconDiv.className="visible";
			expanded = false;
		}
		else if (((mainWidth - maxWidthForOptions) >= 0) && expanded == false)
			{
