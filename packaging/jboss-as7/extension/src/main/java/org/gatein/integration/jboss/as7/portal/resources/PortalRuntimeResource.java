...
public class PortalRuntimeResource extends AbstractPortalResource
{
   ...
   public Set<String> getChildrenNames(String childType)
   {
      ...
      else if (childType.equals(APPLICATION))
      {
         try
         {
            ...
            // should probably use the ApplicationRegistryService at some point, but our statistics are not in sync with this
   ...
   private ResourceEntry getChildEntry(String childType, String name)
   {
      ...
      {
         return new ApplicationRuntimeResource(PathElement.pathElement(APPLICATION, name), portalContext.getPortalContainerName());
      }
